...
<head>
  ...
  <link rel="stylesheet" href={{ asset('HomePageAssets/css/vendor.css') }}>
  <link rel="stylesheet" type="text/css" href="{{ asset('HomePageAssets/style.css') }}">
...
<body>
        ...
        <div class="modal-body">
          <div class="col-lg-12 col-md-12 me-3">
            <div class="image-holder">
              <img id="modalProductImage" width="465px" src="" alt="Shoes">
            </div>
          </div>
          <div class="col-lg-12 col-md-12">
            <div class="summary">
              <div class="summary-content fs-6">
                ...
                <span class="product-price fs-3" id="modalProductPrice"></span>
                <div class="product-details">
                  <p class="fs-7" id="modalProductDesc"></p>
                </div>
                <ul class="select">
                  <li>
                  ...
                  <div class="row">
                    <form action="/add-to-cart" method="post">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="name" id="modalName" hidden>
                        <input type="text" name="price" id="modalPrice" hidden>
                        <input type="text" name="image" id="modalImage" hidden>
                        <input type="hidden" name="product_id" id="modalProductId">
                        <!-- <input type="number" name="quantity" id="quantity" value="1" min="1" hidden> -->
      ...
      <div class="modal-content">
        ...
        @endphp
          ...
          <div class="product-header d-flex justify-content-between align-items-center mb-3">
            ...
            <form action="/remove/{{ $item->cart_id }}" method="Post">
            @csrf
            <button class="remove" aria-label="Remove this item" data-product_id="11913"
          ...
          <div class="quantity-price d-flex justify-content-between align-items-center">
            ...
            <form action="/quantity/{{ $item->cart_id }}" method="post">
            @csrf
            <button type="submit" name="decrease"
            class=" btn btn-light rounded-0 rounded-start btn-number">
            ...
            <form action="/quantity/{{ $item->cart_id }}" method="post">
            @csrf
            <button type="submit" name="increase" class=" btn btn-light rounded-0 rounded-end btn-number">
            <svg width="16" height="16">
              <use xlink:href="#plus"></use>
            </svg>
            </button>
              ...
              <div class="mini-cart-total d-flex justify-content-between py-4">
                ...
                <span class="special-price-code">
                  <span class="price-amount amount fs-6" style="opacity: 1;">
                    <bdi>
                      <span class="price-currency-symbol">Rs.</span>{{ $total }} </bdi>
                  </span>
                </span>
              </div>
      ...
      <div class="container-lg">
        <div class="row justify-content-evenly">
          ...
          <div class="col d-none d-md-block">
            <p class="text-center text-black m-0"><strong>Special Offer</strong>: Free Shipping on all the orders above
              $100
            </p>
          </div>
          <div class="col">
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg">
      <div class="container-lg">
        <a class="navbar-brand" href="index.html">
          <img src={{  asset('HomePageAssets/images/main-logo.png') }} class="logo" alt="logo">
        </a>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="card d-flex flex-row align-items-end border-0 large jarallax-keep-img">
              <img src={{  asset('HomePageAssets/images/card-image1.jpg') }} alt="shoes" class="img-fluid jarallax-img">
            ...
            <div class="row g-4">
              <div class="col-lg-12 mb-4">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  <img src={{  asset('HomePageAssets/images/card-image2.jpg') }} alt="shoes"
              ...
              <div class="col-lg-12">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  <img src={{  asset('HomePageAssets/images/card-image3.jpg') }} alt="shoes"
                    class="img-fluid jarallax-img">
                  <div class="cart-concern p-3 m-3 p-lg-5 m-lg-5">
          ...
          <div class="swiper-slide">
            <div class="card d-flex flex-row align-items-end border-0 large jarallax-keep-img">
              <img src={{ asset('HomePageAssets/images/card-image4.jpg') }} alt="shoes" class="img-fluid jarallax-img">
              <div class="cart-concern p-3 m-3 p-lg-5 m-lg-5">
          ...
          <div class="swiper-slide">
            <div class="row g-4">
              <div class="col-lg-12 mb-4">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  <img src={{ asset('HomePageAssets/images/card-image5.jpg') }} alt="shoes"
                    class="img-fluid jarallax-img">
                  <div class="cart-concern p-3 m-3 p-lg-5 m-lg-5">
              ...
              <div class="col-lg-12">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  <img src={{ asset('HomePageAssets/images/card-image6.jpg') }} alt="shoes"
                    class="img-fluid jarallax-img">
                  <div class="cart-concern p-3 m-3 p-lg-5 m-lg-5">
    ...
    <div class="container-md">
      ...
      <div class="product-content padding-small">
        ...
        <div class="product-card position-relative">
          <div class="card-img">
          <img src={{ asset('uploads/product/' . $product->product_image) }} alt="product-item"
          class="product-image img-fluid">
          <div class="cart-concern position-absolute d-flex justify-content-center">
          <div class="cart-button d-flex gap-2 justify-content-center align-items-center">

          <button type="submit" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modallong">
            <svg class="shopping-carriage">
            <use xlink:href="#shopping-carriage"></use>
            </svg>
          </button>
          <button type="button" class="btn btn-light viewProduct" data-name="{{ $product->product_name }}"
            data-price="{{ $product->product_price }}" data-desc="{{ $product->product_desc }}"
            data-image="{{ asset('uploads/product/' . $product->product_image) }}"
            data-productid="{{ $product->Product_id }}" data-bs-target="#modaltoggle" data-bs-toggle="modal">
          ...
          <span class="card-price fw-bold">Rs. {{ $product->product_price }}</span>
          </div>
        </div>
        </div>
        @endforeach
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="collection-card card border-0 d-flex flex-row align-items-end jarallax-keep-img">
            <img src={{ asset('HomePageAssets/images/collection-item1.jpg') }} alt="product-item"
        ...
        <div class="col-lg-6 col-md-6">
          <div class="collection-card card border-0 d-flex flex-row jarallax-keep-img">
            <img src={{ asset('HomePageAssets/images/collection-item2.jpg') }} alt="product-item"
              class="border-rounded-10 img-fluid jarallax-img">
            <div class="card-detail p-3 m-3 p-lg-5 m-lg-5">
              <h3 class="card-title display-3">
      ...
      <div class="product-content padding-small">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src={{ asset('HomePageAssets/images/card-item7.jpg') }} alt="product-item"
                  class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                    <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modallong">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src={{ asset('HomePageAssets/images/card-item8.jpg') }} alt="product-item"
                  class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                    <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modallong">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src={{ asset('HomePageAssets/images/card-item9.jpg') }} alt="product-item"
                  class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                    <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modallong">
          ...
          <div class="col mb-4 mb-3">
            <div class="product-card position-relative">
              <div class="card-img">
                <img src={{ asset('HomePageAssets/images/card-item10.jpg') }} alt="product-item"
                  class="product-image img-fluid">
                <div class="cart-concern position-absolute d-flex justify-content-center">
                  <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                    <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modallong">
    ...
    <div class="container-lg">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-lg-end">
          <p>Free HTML by <a href="https://templatesjungle.com/" target="_blank">TemplatesJungle</a><br> Distributed by
            <a href="https://themewagon.com" target="blank">ThemeWagon</a> </p>
        </div>
      </div>
    </div>
  </footer>
  <script>
    document.querySelectorAll('.viewProduct').forEach(button => {
      button.addEventListener('click', () => {
        ...
        document.getElementById('modalProductPrice').textContent = 'Rs. ' + button.dataset.price;
        document.getElementById('modalProductDesc').textContent = button.dataset.desc;
        ...
        // Extract just image name from URL
        let imageUrl = button.dataset.image;
        let imageName = imageUrl.substring(imageUrl.lastIndexOf('/') + 1);

        document.getElementById('modalImage').value = imageName;
  ...
  <script src={{ asset('HomePageAssets/js/jquery-1.11.0.min.js') }}></script>
  <script src={{ asset('HomePageAssets/js/plugins.js') }}></script>
  <script src={{ asset('HomePageAssets/js/script.js') }}></script>
</body>
